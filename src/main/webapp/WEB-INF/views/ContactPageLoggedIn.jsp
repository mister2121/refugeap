        ...
        <div class="container">
            <div class="formQuery">
                <form:form action="/addQuery" modelAttribute="userQuery">
                    ...
                    <label class="form-label">Email: </label><form:errors path="email" /><br>
                    <form:input path="email" class="text-input" placeholder="Enter your email..." size="30" />
                    <br />

                    <label class="form-label">Phone Number: </label><form:errors path="phoneNumber" /><br>
                    <form:input path="phoneNumber" class="text-input" placeholder="Enter your phone number..." size="30"/>
                    <br />

                    <label class="form-label">Message: </label><form:errors path="message" /><br>
