<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <head>
        ...
        <title>RefugEAP SignUpErr Page</title>
    </head>
    ...
    <body>
        ...
        <main class="main-row">
            <div class="form-login">
                <p> Your username needs to be between 4 and 32 characters</p>
                <p> Your password needs to be between 6 and 32 characters</p>
                <a href="/SignUp"><button class="submit-input">Go back</button></a>
            </div>
        </main>
        <footer class="footer">
           <div id="footer-text">
