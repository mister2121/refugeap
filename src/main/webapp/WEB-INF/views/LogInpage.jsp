<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <head>
        ...
        <title>RefugEAP LogIn Page</title>
    </head>
        ...
        <main class="main-row">
            <div class="form-login">
                ...
                <form action="/CheckLogIn" method="GET">
                    <input type="text" name="loginusername" class="text-input" placeholder="Username" /><br>
                    <input type="password" name="loginpassword" class="text-input" placeholder="Password" /><br>
