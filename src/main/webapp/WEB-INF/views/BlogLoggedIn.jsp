<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
        ...
        <main class="main-column">
            ...
            <div class="blog-add-button"><a href="newComment?blogID=${blog.id}" id="addComment">Add comment</a>
            </div>
            <br>
            <h4>Comments:</h4>
            <c:forEach items="${comments}" var="comment">
                <div class="blog-comment">
                    ...
                    <a href="deleteComment?commentId=${comment.commentId}"><button type="submit" class="submit-input">Delete</button></a>
                </div>
            </c:forEach>
        </main>
        <footer class="footer">
